...
send_telegram() {
    ...
    TEXT="
╔════════════════════════
║ <b>RENEW VLESS BERHASIL</b>
╠════════════════════════
║ • <b>User:</b> <code>$1</code>
║ • <b>Uuid:</b> <code>$2</code>
...
if [ "$REQUEST_METHOD" = "GET" ]; then
    ...
    if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
        ...
        echo -e "${BGWHITE}      🚫 NO CLIENT FOUND                                        \E[0m"
        echo -e "\033[0;33m━━━━━━━━━━━━━━━━※❆※━━━━━━━━━━━━━━━━\033[0m"
        echo ""
        echo "Tidak ada client VLESS yang tersedia."
        echo ""
        echo -e "\033[0;33m━━━━━━━━━━━━━━━━※❆※━━━━━━━━━━━━━━━━\033[0m"
...
send_telegram "$user" "$uuid" "VLESS" "$SERVERNAMES" "$exp4" "$Quota" "$iplim"
...
if [ "$interactive_mode" = true ]; then
    ...
    output_json "success" "Berhasil memperbarui masa aktif" "$user" "$uuid" "VLESS" "$SERVERNAMES" "$exp4" "$Quota" "$iplim" 0
fi
